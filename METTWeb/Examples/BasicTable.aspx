              ...
              var HomeContainerTab = AssessmentsTab.AddTab("Basic Table");
              {
                var Row = HomeContainerTab.Helpers.DivC("row margin0");
                {
                  var RowCol = Row.Helpers.DivC("col-md-12");
                  {
                    ...
                    var ProductList = RowCol.Helpers.BootstrapTableFor<MELib.Products.Product>((c) => c.ProductList, false, false, "");
                    {
                      var ProductListRow = ProductList.FirstRow;
                      {
                        ...
                        var ProductDescription = ProductListRow.AddColumn("Product Description");
                        {
