  ...
  <%
              using (var h = this.Helpers)
              {
                  ...
                  var LoginDiv = h.Div();
                  {
                      ...
                      var Loginbutton = LoginDiv.Helpers.Button("Log In", Singular.Web.ButtonMainStyle.Info, Singular.Web.ButtonSize.Normal, Singular.Web.FontAwesomeIcon.None);
                      {
                          Loginbutton.AddBinding(Singular.Web.KnockoutBindingString.click, "Login()");
                          Loginbutton.ClickOnEnterKey = true;
                      }
                      var ForgotPasswordBtn = LoginDiv.Helpers.Button("Forgot Password", Singular.Web.ButtonMainStyle.Info, Singular.Web.ButtonSize.Normal, Singular.Web.FontAwesomeIcon.None);
                      {
                  ...
                  var ForgotPasswordDiv = h.Div();
                  {
                      ...
                      {
                          var FPback = FPButtons.Helpers.Button("Back", Singular.Web.ButtonMainStyle.Success, Singular.Web.ButtonSize.Normal, Singular.Web.FontAwesomeIcon.None);
                          {
                              FPback.AddBinding(Singular.Web.KnockoutBindingString.click, "ShowFP()");
                              FPback.AddClass("MarginRight1");
                          }
                          var FPReset = FPButtons.Helpers.Button("Reset Password", Singular.Web.ButtonMainStyle.Success, Singular.Web.ButtonSize.Normal, Singular.Web.FontAwesomeIcon.None);
                          {
