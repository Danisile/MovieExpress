                                            ...
                                            var ContentDiv = AnotherCardDiv.Helpers.DivC("ibox-content");
                                            {
                                                var RightRowContentDiv = ContentDiv.Helpers.DivC("row");
                                                {
                                                    var RightColContentDiv = RightRowContentDiv.Helpers.DivC("col-md-12");
                                                    {
                                                        ...
                                                        var ResetBtn = RightColContentDiv.Helpers.Button("Reset", Singular.Web.ButtonMainStyle.Primary, Singular.Web.ButtonSize.Normal, Singular.Web.FontAwesomeIcon.eraser);
                                                        {
    ...
    <script type="text/javascript">
        ...
        var RentMovie = function (obj) {
            ...
            ViewModel.CallServerMethod('RentMovie', { MovieID: obj.MovieID(), ShowLoadingBar: true }, function (result) {
                if (result.Success) {
                    if (result.Data === "No Funds Please Deposit Money Into Your Account !") {
                        window.alert(result.Data)
                    } else {
                        alert('Movie rental successful')
                        //MEHelpers.Notification("Movie rental successful", 'Centre ', 'Success', 1000);
